...
export default {
  name: "NFTCollectionComponent",
  components: {NFTItemComponent, VueSlickCarousel},
  data() {
    return {
      settings: [
        {
  ...
  .collection-item-wrapper {
    a {
      ...
      .collection-item {
        margin: 5px;
        padding: 20px;
        box-shadow: 0px 6px 12px -6px rgba(58, 182, 171, 0.12), 0px 8px 24px -4px rgba(58, 182, 171, 0.08);
        border-radius: 16px;
