<template>
  <v-row class="image-constructor">
    <v-col>
      <h3>Support people living with HIV, by purchasing a NFT signed by Your favourite Celebrity</h3>
      <div class="step-item">
        <span class="step-item-1">1</span>
        <div class="upload-btn-wrapper">
          <button class="btn">Select an image below (from HIV dedicated collection)</button>
          <input type="file" name="myFile" @change="uploadImage"/>
        </div>
      </div>
      <div class="step-item">
        <span class="step-item-2">2</span>
        Select how do You wish to pay for signhed by Angela Moss NFT
      </div>
      <div class="step-item">
        <span class="step-item-3">3</span>
        You will receive Your NFT to Your email / wallet
